...
(new-object System.Net.WebClient).DownloadFile('https://ffmpeg.zeranoe.com/builds/win64/dev/ffmpeg-4.2.3-win64-dev.zip', $devZipPath);
Expand-Archive $devZipPath -DestinationPath $tempPath -Force

(new-object System.Net.WebClient).DownloadFile('https://ffmpeg.zeranoe.com/builds/win64/shared/ffmpeg-4.2.3-win64-shared.zip', $binZipPath);
